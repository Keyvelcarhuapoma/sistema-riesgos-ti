    ...
    <div className="flex h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-200 text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-slate-800 mb-2">Activos Críticos</h1>
          <p className="text-slate-500 mb-6">Este submódulo está programado para ser desarrollado e integrado en la Fase 2 del proyecto.</p>
